...
| 데이터셋 | v0 | v2 (leak) | v3 | v4 | **v5 (최신)** |
|---------|:---:|:---:|:---:|:---:|:---:|
| CIFAR-10 | 74.53% | 89.09%* | 87.82% | 87.88% | **87.88%** |
| Fashion-MNIST | — | 89.65%* | 90.17% | 89.66% | **90.02%** |
| STL-10 | — | 94.34%* | 94.96% | 94.51% | **94.49%** |

*v2는 test leak된 과대평가. v3부터 train/val/test 엄격 분리.
v5는 데이터셋별 MFA weight 튜닝 (CIFAR 1.0→0.1, Fashion/STL 0.5→0.05).
